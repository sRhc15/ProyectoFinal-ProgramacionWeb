            ...
            <div id="layoutSidenav_content" class="bg-primary">
                <main>
                    ...
                    <form method="POST" action="updateC.php">
                        ...
                        <div class="form-group">
                            <label class="small mb-1" for="inputDesc">Descripcion</label>
                            <input class="form-control py-4" id="inputDesc" name="descripcion" type="text" placeholder="fecha" value="<?php echo $row['descripcion']; ?>"/>
                            
                        </div>
                        <div class="form-group mt-4 mb-0">
                            <button type="submit" class="btn btn-secondary">Modificar Curso</button>
                            <a href="listaC.php" class="btn btn-success">Regresar</a>
                        </div>    
                    </form>
                </main>
