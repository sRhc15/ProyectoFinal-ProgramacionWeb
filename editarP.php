<?php
    ...
    $sql = "SELECT * FROM padre WHERE usuario = '$usuario'";
                ...
                <main>
                    <div class="card-header">
                        <h2><i class="fas fa-table me-1"></i>
                            Usuario de padre: <?php echo $usuario?> </h2>
                    </div>
                    <form method="POST" action="updateP.php">
                        <div class="form-group">
                            <label class="small mb-1" for="inputNombre">Nombre</label>
                            <input class="form-control py-4" id="inputNombre" name="nombre" type="text" placeholder="nombre" value="<?php echo $row['nombre']; ?>"/>
                            <input type="hidden" id="usuario" name="usuario" value="<?php echo $row['usuario'] ?>" />
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="inputTelefono">Telefono</label>
                            <input class="form-control py-4" id="inputTelefono" name="telefono" type="text" placeholder="telefono" value="<?php echo $row['telefono']; ?>"/>     
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="inputCorreo">Correo</label>
                            <input class="form-control py-4" id="inputCorreo" name="correo" type="text" placeholder="correo" value="<?php echo $row['correo']; ?>"/>     
                        </div>
                        <div class="form-group mt-4 mb-0">
                            <button type="submit" class="btn btn-secondary">Modificar Padre</button>
                            <a href="listaP.php" class="btn btn-primary">Regresar</a>
                        </div>    
                    </form>
                </main>
