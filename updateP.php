<?php
    ...
    $sql = "UPDATE padre SET nombre ='$nombre', telefono='$telefono', correo='$correo'  WHERE usuario = '$usuario'";
    $sql2 = "UPDATE usuario SET nombre ='$nombre' WHERE usuario ='$usuario'";
                ...
                <main>
                    <div class ="container">
                        <div class ="row" style="text-align: center">
                            <?php if($resultado) { ?>
                            <h3>Datos de Padre modificados</h3>
                            <?php } else { ?>
