<?php
    ...
    $carnet = $_GET['carnet'];
    $sql = "SELECT * FROM maestro WHERE carnet = '$carnet'";
                ...
                <main>
                    ...
                    <form method="POST" action="updateM.php">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="carnet" name="carnet" value="<?php echo $row['carnet'] ?>" />
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="inputFecha">Fecha</label>
                            <input class="form-control py-4" id="inputFecha" name="fecha" type="text" placeholder="fecha" value="<?php echo $row['fecha']; ?>"/>
                        </div>
                        <div class="form-group mt-4 mb-0">
                            <button type="submit" class="btn btn-success">Modificar Maestro</button>
                            <a href="listaM.php" class="btn btn-primary">Regresar</a>
                        </div>    
                    </form>
                </main>
