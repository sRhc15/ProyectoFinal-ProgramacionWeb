    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content" class="bg-info">
                <main>
                    <h3>Seguro que desea eliminar al usuario de Padre: <?php echo $usuario ?> ? </h3>   
                    <form method="POST" action="deleteP.php">
                        <div class="form-group mt-4 mb-0">
                            <input type="hidden" id="usuario" name="usuario" value="<?php echo $row['usuario'] ?>" />
                            <button type="submit" class="btn btn-danger">Eliminar Padre</button>
                            <a href="listaP.php" class="btn btn-primary">Cancelar</a>
                        </div>  
                </main>
